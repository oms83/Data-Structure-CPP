...
public:
	...
	static short ClalculateVacation(clsDate From, clsDate To)
	{
		short DaysCount = 0;
	...
	short ClalculateVacation(clsDate Date)
	{
		return ClalculateVacation(*this, Date);
	}

	static clsDate ClalculateVacationReturnDate(clsDate Date, short VacationDays)
	{
		clsDate TempDate = Date;
		Date.AddDays(VacationDays);
		short BusinessDays = clsDate::CalculateVacationDays(TempDate, Date);
	...
	void ClalculateVacationReturnDate(short VacationDays)
	{
